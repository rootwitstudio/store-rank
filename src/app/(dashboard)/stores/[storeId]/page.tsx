        ...
        <div className="mb-8">
          ...
          <div className="mt-6 md:mt-8">
            <Tabs defaultValue="overview">
              <TabsList className="bg-transparent p-0 gap-1 border-b w-full rounded-none h-auto overflow-x-auto">
                <TabsTrigger
                  value="overview"
                  className="relative rounded-none border-b-2 border-transparent px-3 py-2 text-sm text-gray-600 hover:text-gray-900 data-[state=active]:text-blue-700 data-[state=active]:font-semibold data-[state=active]:after:content-[''] data-[state=active]:after:absolute data-[state=active]:after:left-0 data-[state=active]:after:right-0 data-[state=active]:after:-bottom-[1px] data-[state=active]:after:h-0.5 data-[state=active]:after:bg-blue-600"
                >
                  Overview
                </TabsTrigger>
                <TabsTrigger
              ...
              <TabsContent value="overview">
                <OverviewTab store={store as any} />
              </TabsContent>
