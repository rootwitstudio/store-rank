      ...
      <div className="container mx-auto px-4 sm:px-6">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6 sm:gap-8 mb-8">
          <div>
            ...
            <ul className="space-y-2 text-sm text-gray-600">
              ...
              <li>
                <Link href="/verified" className="hover:text-blue-600">
                  Verified Stores
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-gray-600">
              <li>
                <Link href="/business/register" className="hover:text-blue-600">
                  List Your Store
                </Link>
              </li>
              <li>
                <Link href="/business/pricing" className="hover:text-blue-600">
                  Pricing
                </Link>
              </li>
              <li>
                <Link href="/business/features" className="hover:text-blue-600">
                  Features
                </Link>
              </li>
              <li>
                <Link href="/business/support" className="hover:text-blue-600">
                  Business Support
                </Link>
              </li>
            </ul>
        ...
        <div className="border-t pt-6 flex flex-col sm:flex-row justify-between items-center text-sm text-gray-600">
          ...
          <div className="text-center sm:text-right">
            © 2024 Trustnbuy. All rights reserved.
          </div>
        </div>
      </div>
    </footer>
